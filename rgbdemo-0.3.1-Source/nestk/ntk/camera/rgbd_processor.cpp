...
namespace ntk
{
  ...
  void RGBDProcessor :: undistortImages()
  {
    ...
    remap(rgb_im, tmp3b,
          ...
          CV_INTER_LINEAR);
    // undistort(rgb_im, tmp3b,
    //         m_image->calibration()->rgb_intrinsics,
    //         m_image->calibration()->rgb_distortion);
    tmp3b.copyTo(rgb_im);
    ...
    if (m_flags & NoAmplitudeIntensityUndistort)
    {
    ...
    // undistort(m_image->rawAmplitudeRef(), m_image->amplitudeRef(), m_image->calibration()->depth_intrinsics, m_image->calibration()->depth_distortion);
    // undistort(m_image->rawDepthRef(), m_image->depthRef(), m_image->calibration()->depth_intrinsics, m_image->calibration()->depth_distortion);
    // undistort(m_image->rawIntensityRef(), m_image->intensityRef(), m_image->calibration()->depth_intrinsics, m_image->calibration()->depth_distortion);
  }
