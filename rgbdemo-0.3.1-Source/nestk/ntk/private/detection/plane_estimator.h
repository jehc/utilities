...
#ifndef NTK_DETECTION_PLANE_ESTIMATOR_H
#define NTK_DETECTION_PLANE_ESTIMATOR_H
...
namespace ntk
{
  ...
  public:
    PlaneEstimator();
    void estimate(ntk::RGBDImage& image, bool remove_plane_pixels);
...
#endif // NTK_DETECTION_PLANE_ESTIMATOR_H
