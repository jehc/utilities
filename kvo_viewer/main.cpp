...
main (int argc, char ** argv)
{
  ...
  QObject::connect (tfR, SIGNAL(transferFunctionChanged (const QVector<float> &)), kvo, SLOT(transferFunctionRChanged(const QVector<float> &)));
  QObject::connect (tfG, SIGNAL(transferFunctionChanged (const QVector<float> &)), kvo, SLOT(transferFunctionGChanged(const QVector<float> &)));
  QObject::connect (tfB, SIGNAL(transferFunctionChanged (const QVector<float> &)), kvo, SLOT(transferFunctionBChanged(const QVector<float> &)));
  QObject::connect (tfA, SIGNAL(transferFunctionChanged (const QVector<float> &)), kvo, SLOT(transferFunctionAChanged(const QVector<float> &)));
